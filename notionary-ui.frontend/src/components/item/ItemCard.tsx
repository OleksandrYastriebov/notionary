    ...
    <>
      <motion.div
        ...
        className={`group rounded-2xl border transition-all duration-200 overflow-hidden ${
          ...
          hasImage
            ? 'bg-[#111118] border-white/[0.06] hover:border-white/[0.12] hover:shadow-lg hover:shadow-black/40 flex flex-col'
            : 'bg-[#111118] border-white/[0.06] hover:border-white/[0.12] hover:shadow-lg hover:shadow-black/40 flex flex-row items-stretch'
        }`}
      >
        {hasImage ? (
          ...
          /* Horizontal compact card (no image) */
          <>
            {/* Content */}
            <div className="flex-1 min-w-0 p-4 flex flex-col justify-between">
              <div>
                ...
                {item.price !== null && (
                  <div className="flex items-center gap-1 text-sm font-semibold text-violet-400 mt-1">
                    <DollarSign size={13} />
                    {item.price.toFixed(2)}
                  </div>
                )}
                ...
                {item.description && (
                  <p className="text-xs text-[#9898b4] mt-1 line-clamp-2">{item.description}</p>
                )}
              </div>
