...
const EditWishlistItem = ({ item, wishlistId, onClose, onUpdated }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const updateData = {}
      if (data.title !== item.title) updateData.title = data.title
      if (data.price !== item.price) updateData.price = data.price ? Number(data.price) : null
      if (data.url !== item.url) updateData.url = data.url || null
      if (data.description !== item.description) updateData.description = data.description || null
      if (imageUrl !== item.imageUrl) updateData.imageUrl = imageUrl || null

      await wishlistItemApi.updateWishlistItem(wishlistId, item.id, updateData)
